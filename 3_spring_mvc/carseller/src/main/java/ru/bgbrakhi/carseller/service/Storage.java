...
public class Storage implements IStorage {
    ...
    public List<Car> getAllCars(UserFilter filter, Boolean onlyActive) {
        try (Session session = factory.openSession()) {
...
*/
                if (!COANTANT_FILTER_ALL_MARKS.equals(filter.getMark()) && !filter.getMark().isEmpty()) {
                    builder.append(String.format(" and ce.carmodel.carmark.name = '%s'", filter.getMark()));
                }
                if (filter.getToday()) {
